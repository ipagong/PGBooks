...
class NewTopController: UIViewController, BookDetailTransitionable {

    @IBOutlet weak var tableview : UITableView!
    
    private lazy var viewModel:NewViewModel = { NewViewModel.init() }()
    ...
    func setupUI() {
        self.title = ServiceType.new.title
