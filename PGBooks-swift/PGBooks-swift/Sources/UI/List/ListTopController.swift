...
class ListTopController: UIViewController, BookDetailTransitionable {

    @IBOutlet weak var tableview : UITableView!
    
    private lazy var viewModel:ListViewModel = { ListViewModel.init() }()
    ...
    func setupUI() {
        self.title = ServiceType.list.title
